...
class DetailPrescriptionDr extends StatefulWidget {

  BuildContext mycontext;
  int ID;
  DetailPrescriptionDr({this.ID,this.mycontext});
  @override
  _DetailPrescriptionDrState createState() => _DetailPrescriptionDrState();
}

class _DetailPrescriptionDrState extends State<DetailPrescriptionDr> {
