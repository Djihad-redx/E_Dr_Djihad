...
class AddNewPharm extends StatefulWidget {
  @override
  _AddNewPharmState createState() => _AddNewPharmState();
}

class _AddNewPharmState extends State<AddNewPharm> {
                          ...
                          InkWell(
                            onTap: (){
                              ...
                              if (name.text.isEmpty == true){
                                ...
                                Api.CreatePharm(name.text.toString(),email.text.toString(),mobile.text.toString(),password1.text.toString(),password2.text.toString(),status).then((value2) {
                                  print(value2);
                                  setState(() {
                                    isloading = false;
                                  });
