...
class DetailnotifDr extends StatefulWidget {

  BuildContext mycontext;

  int ID;
  DetailnotifDr({this.ID,this.mycontext});
  @override
  _DetailnotifDrState createState() => _DetailnotifDrState();
}

class _DetailnotifDrState extends State<DetailnotifDr> {
