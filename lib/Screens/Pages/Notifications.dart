                          ...
                          Padding(
                            ...
                            child: InkWell(
                              onTap: () async {
                                ...
                                final reLoadPage = await  Navigator.of(widget.mycontext).push(MaterialPageRoute(builder: (context) => Detailnotif(ID: snapshot.data[index].prescriptionId,mycontext: widget.mycontext,),));
                                if (ok == true){
                                  if (reLoadPage){
                                    setState(() {
                                      isreaded = true;
