...
class UpdatePharm extends StatefulWidget {
  UpdatePharm({this.result});
  DataDoctor result;

  @override
  _UpdatePharmState createState() => _UpdatePharmState();
}

class _UpdatePharmState extends State<UpdatePharm> {
        ...
        body: SafeArea(
          child: Stack(
            children: [
              Column(
                children: [
                  HeaderApp(Title: widget.result.name,icon: Icons.arrow_back,c: context,),
                  Expanded(
                    child: Padding(
                        ...
                        children: [
                          ...
                          InkWell(
                            onTap: (){
                              ...
                              Api.UpdatePharm(widget.result.id.toString(),name.text.toString(),email.text.toString(),mobile.text.toString(),password1.text.toString(),password1.text.toString(),status).then((value2) {
                                print(value2);
                                setState(() {
                                  isloading = false;
                                });
